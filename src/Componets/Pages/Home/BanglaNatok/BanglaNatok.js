...
const BanglaNatok = () => {
    ...
    useEffect(() => {
        fetch('https://bongo-movie.onrender.com/bongo/banglaNatok', {
            method: 'GET',
            headers: {
    ...
    return (
        <div className='container-fluid mt-5'>
            <div className="main-title">
                <h3 className='text-light mb-2 fs-4'>Bangla Natok</h3>
